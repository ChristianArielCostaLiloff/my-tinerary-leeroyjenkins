    ...
    return (
        <>
            <div className='container_carouselandarrows'>
                <div>
                    <button onClick={back} className="btn_carousel_back">PREVIOUS</button>
                </div>
                <div>
                    ...
                    <div className="container_card">
                        ...
                        <div className="card">
                            <figure className='container_img'><img className="card_img" src={photos[4 * 1 + index].photo} alt="" /></figure>
                            <span className="card_name">{photos[4 * 1 + index].name}</span>
                        </div>
                        <div className="card">
                            <figure className='container_img'>
                                <img className="card_img" src={photos[4 * 2 + index].photo} alt="" />
                            </figure>
                            <span className="card_name">{photos[4 * 2 + index].name}</span>
                        </div>
                        <div className="card">
                            <figure className='container_img'>
                                <img className="card_img" src={photos[4 * 3 + index].photo} alt="" />
                            </figure>
                ...
                <div>
                    <button onClick={next} className="btn_carousel_forward">NEXT</button>
                </div>
            </div>
        </>
    );
